<template>
	<view class="container">
		...
		<view class="user-section">
			...
			<view class="user-info-box">
				<view class="portrait-box">
					<image class="portrait" :src="merchantInfo.logo || '/static/missing-face.png'"></image>
				</view>
				<!-- 				<view class="info-box">
					<text class="username">{{merchantInfo.name || '未设置昵称'}}</text>
				</view> -->
			</view>
		...
		<uni-popup ref="showshare" :type="type">
			<!-- #ifdef H5 -->
			<shareByH5 :shareType='1' :userId="merchantInfo.merchantUuid" :shareHref="shareHref" @close="closeShare()"></shareByH5>
			<!-- #endif -->
			...
			<!-- #ifdef MP-ALIPAY -->
			<shareByAli :shareType='1' :userId="merchantInfo.merchantUuid" :shareHref="shareHref" @close="closeShare()"></shareByAli>
			<!-- #endif -->

			<!-- #ifdef APP-PLUS -->
			<shareByApp :shareType='1' :userId="merchantInfo.merchantUuid" :shareHref="shareHref" @close="closeShare()"></shareByApp>
			<!-- #endif -->
		</uni-popup>
	...
	export default {
		...
		computed: {
			...
			shareHref() {
				...
				return this.$api.request.apiBaseUrl.replace("/b2c/rest/","") + '/#/pages/public/register?id=' + this.merchantInfo.merchantUuid;
				// #endif
